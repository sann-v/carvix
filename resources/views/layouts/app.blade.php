...
<body>
    ...
    <nav class="navbar">
        <a href="{{ route('home') }}" class="navbar-brand">
            <img src="{{ asset('images/logo.png') }}" alt="Skensa Auto Service" class="logo-icon">

            <div class="brand-text">
                <span style="color:white">Skensa Auto Service</span>
            </div>
        </a>
        ...
        <ul class="nav-links">
            ...
            @auth
                ...
                <li><a href="{{ route('history') }}"
                        class="{{ request()->routeIs('history') ? 'active' : '' }}">RIWAYAT</a></li>
            @endauth
        </ul>
                    ...
                    <div class="user-dropdown" id="userDropdown">
                        ...
                        <a href="{{ route('history') }}" class="dropdown-item">
                            <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                                ...
                                <path d="M7 4V7L9 9" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" />
                            </svg>
                            Riwayat Layanan
                        </a>
                        <div class="dropdown-divider"></div>
                        <form action="{{ route('logout') }}" method="POST">
                            ...
                            <button type="submit" class="dropdown-item dropdown-logout">
                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                                    <path d="M5 2H2a1 1 0 00-1 1v8a1 1 0 001 1h3M9 10l3-3-3-3M5 7h7" stroke="currentColor"
            ...
            @else
                ...
                <a href="{{ route('login') }}" class="btn-nav-login">
                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                        ...
                        <path d="M1.5 12c0-2.485 2.462-4.5 5.5-4.5s5.5 2.015 5.5 4.5" stroke="currentColor"
    ...
    <footer class="footer">
        ...
        <div class="footer-bottom">
            <p>© {{ date('Y') }} Skensa Auto Service. Semua hak dilindungi.</p>
        </div>
    </footer>
