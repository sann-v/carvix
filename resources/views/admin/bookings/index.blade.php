...
<div style="padding:2rem;max-width:1200px;margin:0 auto">
    ...
    <div style="margin-bottom:2rem">
        <a href="{{ route('admin.dashboard') }}" style="font-size:.85rem;color:#f59e0b;text-decoration:none;font-weight:600">← Dashboard</a>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(340px,1fr));gap:1.25rem">
        ...
        <div style="background:#fff;border:1px solid #e5e7eb;border-radius:14px;padding:1.5rem;display:flex;flex-direction:column;gap:1rem;box-shadow:0 2px 8px rgba(0,0,0,.06)">
            ...
            <a href="{{ route('admin.bookings.show', $b->id) }}"
               style="text-align:center;padding:.65rem;background:#f59e0b;color:#000;border-radius:8px;font-size:.85rem;font-weight:700;text-decoration:none">
                Kelola →
            </a>
        </div>
        @empty
