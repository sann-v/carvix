    ...
    <div class="modules-inner">
        ...
        <div class="modules-header">
            <div>
                ...
                <p class="modules-sub">Setiap tonggak layanan ditangkap dan dilacak dalam ekosistem digital aman kami.</p>
            </div>
        ...
        <div class="modules-cards">
            <div class="mod-card mod-card-large">
                ...
                <p>Penjadwalan intuitif dengan konfirmasi instan. Pilih jenis layanan, tanggal, dan dapatkan kode booking dalam hitungan detik.</p>
            ...
            <div class="mod-card">
                ...
                <p>Buku besar digital lengkap dari setiap servis, penggantian suku cadang, dan catatan diagnostik kendaraan Anda.</p>
                @auth
        ...
        <div class="invoice-row {{ !$pendingInvoice ? 'invoice-row-fullwidth' : '' }}">
            ...
            <div class="invoice-row-left">
                ...
                <p>Tidak ada biaya tersembunyi. Setiap layanan tercatat dengan rincian lengkap — suku cadang, biaya jasa, dan pajak ditampilkan secara jelas. Faktur digital diterbitkan otomatis setelah layanan selesai dan bisa diunduh kapan saja.</p>
            ...
            <div class="invoice-row-right">
                <div class="inv-preview-enhanced">
                    ...
                    <div class="inv-preview-top">
                        <span style="color:var(--orange);font-weight:800;font-family:var(--font-d);font-size:.85rem;letter-spacing:.05em">
                            ◈ CARVIX
                        </span>
                        <span style="font-size:.72rem;font-weight:700;padding:4px 12px;border-radius:999px;background:#fef3c7;color:#92400e;border:1px solid #fde68a">
                            BELUM LUNAS
                        </span>
                    </div>
                    ...
                    <div class="inv-preview-title">
                        ...
                        <p class="inv-date">Diterbitkan: {{ \Carbon\Carbon::parse($pendingInvoice->issue_date)->format('d M Y') }}</p>
                    </div>
                    ...
                    <div class="inv-preview-items">
                        ...
                        <div class="inv-item-row">
                            ...
                            <span class="inv-item-price">Rp {{ number_format($pendingInvoice->subtotal, 0, ',', '.') }}</span>
                        </div>
                        @endforelse
                    </div>
                    ...
                    <div class="inv-preview-total">
                        ...
                        <span class="inv-total-amount">Rp {{ number_format($pendingInvoice->total, 0, ',', '.') }}</span>
                    </div>

                    {{-- Jatuh tempo --}}
                    @if(\Carbon\Carbon::parse($pendingInvoice->due_date)->isPast())
                        <p style="font-size:.72rem;color:#dc2626;font-weight:700;margin-bottom:.75rem;text-align:center;background:#fee2e2;padding:.4rem;border-radius:6px">
                    ...
                    @else
                        <p style="font-size:.72rem;color:#92400e;margin-bottom:.75rem;text-align:center">
                            Jatuh tempo: <strong>{{ \Carbon\Carbon::parse($pendingInvoice->due_date)->format('d M Y') }}</strong>
                        </p>
                    @endif
...
<section class="heritage-section">
    <div class="heritage-inner">
            ...
            <div class="heritage-img">
                ...
                <div class="heritage-slider" id="heritageSlider">
                    <div class="heritage-slider-track" id="heritageSliderTrack">
                        <div class="heritage-slide"><img src="{{ asset('images/gallery/slide1.jpg') }}" alt="Carvix Workshop 1" loading="lazy"></div>
                        <div class="heritage-slide"><img src="{{ asset('images/gallery/slide2.jpg') }}" alt="Carvix Workshop 2" loading="lazy"></div>
                        <div class="heritage-slide"><img src="{{ asset('images/gallery/slide3.jpg') }}" alt="Carvix Workshop 3" loading="lazy"></div>
                        <div class="heritage-slide"><img src="{{ asset('images/gallery/slide4.jpg') }}" alt="Carvix Workshop 4" loading="lazy"></div>
                        <div class="heritage-slide"><img src="{{ asset('images/gallery/slide5.jpg') }}" alt="Carvix Workshop 5" loading="lazy"></div>
                        <div class="heritage-slide"><img src="{{ asset('images/gallery/slide6.jpg') }}" alt="Carvix Workshop 6" loading="lazy"></div>
                    </div>
        ...
        <div class="heritage-text">
            <p class="heritage-eyebrow">TENTANG CARVIX</p>
            ...
            <div class="heritage-features">
                <div class="hf-item">
                    ...
                    <p>Lebih dari 150 bengkel mitra bersertifikat di seluruh Indonesia.</p>
                </div>
                <div class="hf-item">
                    <h4>Standar OEM</h4>
                    <p>Setiap teknisi disertifikasi produsen otomotif terkemuka dengan standar internasional.</p>
                </div>
            </div>
...
<section class="track-cta-section">
    <div class="track-cta-inner">
        <div class="track-cta-left">
            <p class="hero-eyebrow" style="color:var(--orange)">LACAK KENDARAAN ANDA</p>
            <h2>Pantau Status Servis<br>Secara <span style="color:var(--orange)">Real-Time</span></h2>
            <p style="color:rgba(255,255,255,0.6);margin-top:1rem;max-width:420px">
        ...
        <div class="track-cta-right">
            <div class="track-cta-form">
                ...
                <button onclick="var v=document.getElementById('homVin').value.trim();if(v)window.location='/track/'+v;else window.location='{{ route('track') }}'"
                        class="track-cta-btn">
                    LACAK SEKARANG →
                </button>
            </div>
            <p style="font-size:.75rem;color:rgba(255,255,255,0.4);margin-top:.75rem">
                ...
                <a href="{{ route('track') }}" style="color:var(--orange)">Klik di sini</a>
            </p>
        </div>
    </div>
</section>
